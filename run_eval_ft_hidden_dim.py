...
params_adds = params_adds.sort_values('hiddem_dim', ascending=False)[0].values.tolist()
...
auc_frame = []
for param_add, hyperparam in zip(params_adds, Fine_tune('fc_params_act_type', values)):
