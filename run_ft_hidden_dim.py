...
save_address = 'OURs_new_ft_hidden_dim'
    ...
    while True:
        ...
        OURS_ori = ConvNet(conv_params = {'kernel': ((1,16), (1,8), (1,8)), 
                                ...
                                pool_params = {'pool_type': ('avg', 'avg', 'avg',),
                                            ...
                                            'padding': ((0,0),(0,0), (0,0),),
                                            'dilate': ((1,1), (1,1), (1,1),)},
                                fc_params = {'hidden_dim': (hidden_dim,)}, drop_prob = 0, 
        #                         input_dim = (2,1,8192)
                                input_dim = (1,1,8192)
                            )
        ...
        Solver = Solver_nd(model = OURS_ori, 
                        ...
                        ,checkpoint_name = 'hidden_dim_%s' %int(hidden_dim),floydhub_verbose =True,)
...
# -m "OURs_old_ft_hidden_dim" \
# "bash setup_floydhub.sh && python run_ft_hidden_dim.py && python run_eval_ft_hidden_dim.py"                