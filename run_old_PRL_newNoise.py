...
for snr in SNR_list:
    ...
    try:
        ...
        params_ = nd.load('./SNR%s_PRL/params_%s'  %( int(snr*100) ,best_params_epoch))
...
# -m "AUCPRL_old_newNoise" \
# "bash setup_floydhub.sh && python run_old_PRL_newNoise.py"
...
# --data wctttty/datasets/ligo_localnoise_9_9000_8192/1:ligo_localnoise_9_9000_8192_1 \
# --data wctttty/datasets/ligo_localnoise_9_9000_8192/2:ligo_localnoise_9_9000_8192_2 \
# --data wctttty/projects/python4gw/296:params \
# -m "AUCPRL_old_newNoise" \
# "bash setup_floydhub.sh && python run_old_PRL_newNoise.py"
