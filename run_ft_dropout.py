...
drop_prob_list = [0, 0.25, 0.5, 0.75]
save_address = 'OURs_new_dropout'
    ...
    while True:
        ...
        OURS_ori = ConvNet(conv_params = {'kernel': ((1,16), (1,8), (1,8)), 
                                ...
                                pool_params = {'pool_type': ('avg', 'avg', 'avg',),
                                            ...
                                            'padding': ((0,0),(0,0), (0,0),),
                                            'dilate': ((1,1), (1,1), (1,1),)},
                                fc_params = {'hidden_dim': (64,)}, drop_prob = drop_prob, 
        #                         input_dim = (2,1,8192)
                                input_dim = (1,1,8192)
                            )
        ...
        Solver = Solver_nd(model = OURS_ori, 
                        ...
                        ,checkpoint_name = 'drop_prob_%s' %int(drop_prob*100),floydhub_verbose =True, )
...
# -m "OURs_old_ft_dropout" \
# "bash setup_floydhub.sh && python run_ft_dropout.py && python run_eval_ft_dropout.py"        