...
# Fine_tune = 'pooling'
# Fine_tune_list1 = ['max', 'max', 'max', 'max', 'avg', 'avg', 'avg']
# Fine_tune_list2 = [32, 16, 8, 4, 32, 8, 4]
...
################################
    for snr in SNR_list:
        ...
        try:
            ...
            params_ = nd.load('./SNR%s_%s/params_%s'  %( int(snr*100) ,model_name, best_params_epoch))
