...
for model_name, model in zip(model_names, models):
    ...
    for SNR_ in SNR_list:  # 不同的模型参数
        auc_ = []
        address = '../input/%s_old_newNoise/SNR%s_%s/' %(model_name, int(SNR_*10) ,model_name)
...
# --data wctttty/projects/python4gw/265:OURs_old_newNoise \
# --data wctttty/projects/python4gw/270:PRL_old_newNoise \
# --data wctttty/projects/python4gw/267:PLB_old_newNoise \
# -m "AUC_OURs/PLB/PRL_old_newNoise" \
# "bash setup_floydhub.sh && python AUC_OURs_PLB_PRL_old_newNoise.py"
